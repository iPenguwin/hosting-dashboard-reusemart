...
class RequestPasswordReset extends BaseRequestPasswordReset
{
    ...
    public function request(): void
    {
        ...
        $user = Penitip::where('EMAIL_PENITIP', $data['email'])->first();
        ...
        $resetUrl = Filament::getResetPasswordUrl($token, $user, ['EMAIL_PENITIP' => $user->EMAIL_PENITIP]);

        try {
            \Mail::to($user->EMAIL_PENITIP)
                ->send(new \App\Mail\PenitipResetPasswordMail($user->name, $resetUrl));
