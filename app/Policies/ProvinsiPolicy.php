...
class ProvinsiPolicy
{
     ...
     */
    public function view(Pegawai $pegawai, Provinsi $provinsi): bool
    {
        return true;
    }
     ...
     */
    public function update(Pegawai $pegawai, Provinsi $provinsi): bool
    {
        return true;
    }
     ...
     */
    public function delete(Pegawai $pegawai, Provinsi $provinsi): bool
    {
        return true;
    }
     ...
     */
    public function restore(Pegawai $pegawai, Provinsi $provinsi): bool
    {
        return true;
    }
     ...
     */
    public function forceDelete(Pegawai $pegawai, Provinsi $provinsi): bool
    {
        return true;
    }
}
