...
class PembeliPolicy
{
     ...
     */
    public function view(Pegawai $pegawai, Pembeli $pembeli): bool
    {
        return true;
    }
     ...
     */
    public function update(Pegawai $pegawai, Pembeli $pembeli): bool
    {
        return true;
    }
     ...
     */
    public function delete(Pegawai $pegawai, Pembeli $pembeli): bool
    {
        return true;
    }
     ...
     */
    public function restore(Pegawai $pegawai, Pembeli $pembeli): bool
    {
        return true;
    }
     ...
     */
    public function forceDelete(Pegawai $pegawai, Pembeli $pembeli): bool
    {
        return true;
    }
}
